...
Following up on the announcement [here](https://d2lang.com/blog/d2-non-profit/), TALA (Terrastruct's AutoLayout Algorithm) is now open-source under the same permissive license as D2 (MPL-2.0).
...
- It doesn't do DAGs as well. I often myself preferring Dagre or ELK when I want a long flowing graph.
...
Special thanks to Gavin Nishizawa for substantial broad contributions across TALA, and Júlio César Batista for his work on hierarchy algorithms and more. It was so fun getting to work on stuff like this.
